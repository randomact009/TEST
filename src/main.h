...
static const int64 MAX_MONEY = maxmoney0 * COIN; // 
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // Moneyenom: 480 blocks found a day. Priority cutoff is 1 Moneyenom day / 250 bytes.
    }
