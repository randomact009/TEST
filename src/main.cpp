...
// Copyright (c) 2011-2013 Moneyenom Developers.
...
static const int64 nTargetTimespan =  15 * 4 * 15; // Moneyenom: 15 mins
static const int64 nTargetSpacing = 15; // 15 sec
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Moneyenom: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    printf(" nActualTimespan = %"PRI64d" before bounds\n", nActualTimespan);        
         ...
         int64 nActualTimespanMax = ((nTargetTimespan*75)/56);
         int64 nActualTimespanMin = ((nTargetTimespan*56)/75);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Moneyenom miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Moneyenom", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0xaa, 0xc8, 0xab, 0x19 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Moneyenomd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
